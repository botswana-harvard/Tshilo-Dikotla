...
MIGRATION_MODULES = {"tshilo_dikotla.apps_old.td_infant": "tshilo_dikotla.apps_old.td_infant.migrations_not_used_in_tests",
                     "tshilo_dikotla.apps_old.td_maternal": "tshilo_dikotla.apps_old.td_maternal.migrations_not_used_in_tests",
