    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('aliquot_datetime', models.DateTimeField(default=datetime.datetime(2016, 5, 7, 14, 6, 15, 273423), verbose_name='Date and time aliquot created')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('receive_datetime', models.DateTimeField(db_index=True, default=datetime.datetime(2016, 5, 7, 14, 6, 15, 104430), validators=[edc_base.model.validators.date.datetime_not_future], verbose_name='Date and time received')),
