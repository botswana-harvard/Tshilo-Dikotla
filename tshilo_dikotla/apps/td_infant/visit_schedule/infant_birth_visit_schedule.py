...
class InfantBirthVisitSchedule(VisitScheduleConfiguration):
    ...
    visit_definitions['2000'] = {
        ...
        'instructions': None,
        'requisitions': (
            RequisitionPanelTuple(10, u'td_lab', u'infantrequisition',
                                  'DNA PCR', 'TEST', 'WB', NOT_REQUIRED, ADDITIONAL),
            RequisitionPanelTuple(20, u'td_lab', u'infantrequisition',
                                  'Stool storage', 'STORAGE', 'ST', NOT_REQUIRED, ADDITIONAL),
            RequisitionPanelTuple(30, u'td_lab', u'infantrequisition',
                                  'PBMC Plasma (STORE ONLY)', 'STORAGE', 'WB', NOT_REQUIRED, ADDITIONAL),
            RequisitionPanelTuple(40, u'td_lab', u'infantrequisition',
                                  'Rectal swab (Storage)', 'STORAGE', 'RS', REQUIRED, NOT_ADDITIONAL),
            RequisitionPanelTuple(70, u'td_lab', u'infantrequisition',
                                  'Viral Load', 'TEST', 'WB', NOT_REQUIRED, ADDITIONAL),
            RequisitionPanelTuple(80, u'td_lab', u'infantrequisition',
                                  'Chemistry', 'TEST', 'WB', NOT_REQUIRED, ADDITIONAL),
            RequisitionPanelTuple(90, u'td_lab', u'infantrequisition',
...
#             CrfTuple(110, u'td_infant', u'infantstoolcollection', REQUIRED, NOT_ADDITIONAL),
    ...
    visit_definitions['2200'] = {
        ...
        'requisitions': (
            ...
            RequisitionPanelTuple(40, u'td_lab', u'infantrequisition',
                                  'Rectal swab (Storage)', 'STORAGE', 'RS', REQUIRED, NOT_ADDITIONAL),
            RequisitionPanelTuple(60, u'td_lab', u'infantrequisition',
