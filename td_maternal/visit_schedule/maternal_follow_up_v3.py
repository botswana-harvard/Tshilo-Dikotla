...
class MaternalFollowUpSchedule3(VisitScheduleConfiguration):
    ...
    membership_forms = OrderedDict({'follow_upv3': MembershipFormTuple(
        'follow_upv3', MaternalLabourDel, True), })

    schedules = OrderedDict({
        'Follow Up Visit v3': ScheduleTuple('Follow Up Visit v3', 'follow_upv3', None, None), })
