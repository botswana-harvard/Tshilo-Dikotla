...
# #               'who',
#     )
    list_display = ('maternal_visit', 'chronic_since', 'sero_positive', 'date_hiv_diagnosis', 'perinataly_infected',
                    'lowest_cd4_known', 'cd4_count', 'cd4_date')
    list_filter = ('chronic_since', 'sero_positive', 'date_hiv_diagnosis', 'perinataly_infected')
